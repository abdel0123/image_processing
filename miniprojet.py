...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        MainWindow.setObjectName("Projet Image")
        MainWindow.resize(1064, 650)
        ...
        self.ImageFinale.setGeometry(QtCore.QRect(560, 60, 481, 461))
        self.ImageFinale.setText("")
        self.ImageFinale.setObjectName("ImageFinale")
        self.reset = QtWidgets.QPushButton(self.centralwidget)
        self.reset.setGeometry(QtCore.QRect(370, 560, 311, 31))
        ...
        self.label_2.setGeometry(QtCore.QRect(560, 10, 191, 31))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.line.setGeometry(QtCore.QRect(520, 20, 20, 531))
        self.line.setFrameShape(QtWidgets.QFrame.VLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.line_2 = QtWidgets.QFrame(self.centralwidget)
        self.line_2.setGeometry(QtCore.QRect(10, 40, 1041, 20))
        self.line_2.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.line_3 = QtWidgets.QFrame(self.centralwidget)
        self.line_3.setGeometry(QtCore.QRect(10, 540, 1041, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("Projet d'image", "Projet d'image"))
        self.reset.setText(_translate("MainWindow", "reinitialiser"))
        ...
        self.gausien3x3.setText(_translate("MainWindow", "3x3"))
        self.gausien5x5.setText(_translate("MainWindow", "5x5"))
        ...
        self.actionEnregistrer.triggered.connect(self.enregistrementimage)
    ...
    def rest(self):
        self.ImageOrigine.setText(" ")
        self.ImageFinale.setText(" ")
        self.label_2.setText("L\'image resultat")
